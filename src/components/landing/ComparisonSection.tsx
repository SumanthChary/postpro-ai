...
const ComparisonSection = () => {
  return (
    <section className="py-12 md:py-16 bg-gradient-to-r from-light-lavender to-white">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-montserrat font-bold text-center mb-4 md:mb-8">
          Real Results from LinkedIn Pros
        </h2>
        <p className="text-base sm:text-lg text-center mb-6 md:mb-10 max-w-3xl mx-auto text-custom-text">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
          <Card className="p-4 sm:p-6 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg sm:text-xl font-semibold text-electric-purple">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-l-4 border-bright-teal hover:transform hover:-translate-y-1 transition duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                <TrendingUpIcon className="w-5 h-5 sm:w-6 sm:h-6 text-bright-teal shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2">2,480% Boost in Post Impressions</h4>
                  <p className="text-sm sm:text-base text-custom-text">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-l-4 border-bright-teal hover:transform hover:-translate-y-1 transition duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                <TrendingUpIcon className="w-5 h-5 sm:w-6 sm:h-6 text-bright-teal shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2">1,850% Follower Growth</h4>
                  <p className="text-sm sm:text-base text-custom-text">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-l-4 border-bright-teal hover:transform hover:-translate-y-1 transition duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                <LinkIcon className="w-5 h-5 sm:w-6 sm:h-6 text-bright-teal shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2">4,350% More Profile Views</h4>
                  <p className="text-sm sm:text-base text-custom-text">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border-l-4 border-bright-teal hover:transform hover:-translate-y-1 transition duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                <TrendingUpIcon className="w-5 h-5 sm:w-6 sm:h-6 text-bright-teal shrink-0 mt-1" />
                <div>
                  <h4 className="text-base sm:text-lg font-semibold mb-1 sm:mb-2">11.5x Higher Engagement Rate</h4>
                  <p className="text-sm sm:text-base text-custom-text">

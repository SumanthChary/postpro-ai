            ...
            <div className="mt-4 grid gap-6 md:grid-cols-3">
              {highlightCredits.map(pack => (
                <div key={pack.name} className="rounded-2xl border border-blue-100 bg-blue-50/40 p-6">
                  ...
                  <p className="text-sm text-gray-600">Credits never expire • LinkedIn extension included</p>
                  <ul className="mt-4 space-y-2 text-sm text-gray-700">
                    <li>1 credit = 1 LinkedIn enhancement + virality check</li>
                    ...
                    onClick={() => {
                      const creditPlan: Plan = {
                        ...
                        features: [
                          ...
                          "LinkedIn extension + web access included"
                        ],
                        cta: `Buy ${pack.name}`,
                        currency: "USD"
                      };

        ...
        <div className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg sm:text-xl text-gray-600">
              A single account unlocks the dashboard, Firefox/Chrome extension, and AI workflows that ship high-performing posts in minutes.
            </p>
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-3">
                {creditPacks.map((pack) => (
                  <div key={pack.name} className="rounded-2xl border border-blue-100 bg-blue-50/40 p-6">
                    ...
                    <p className="text-sm text-gray-600">1 credit = 1 enhancement + virality check</p>
          ...
          <div className="mt-24 max-w-5xl mx-auto">
            <div className="grid gap-6 md:grid-cols-3">
              {[
                "Extension + web access with one subscription",

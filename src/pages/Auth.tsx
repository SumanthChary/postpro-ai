  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-900 relative">
        <div className="flex flex-col justify-center px-12 xl:px-20 text-white w-full">
          <div className="mb-12">
            <div className="flex items-center mb-8">
              ...
              />
              <span className="text-2xl font-bold">PostPro AI</span>
            </div>
            
            <h1 className="text-4xl font-bold leading-tight mb-4">
              Professional Content<br />Enhancement Platform
            </h1>
            <p className="text-lg text-gray-300 leading-relaxed">
              Join thousands of professionals creating high-quality content with AI-powered tools.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-300">AI-powered content enhancement</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center">
                <div className="w-2 h-2 bg-white rounded-full"></div>
              </div>
              <span className="text-gray-300">Professional templates & analytics</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center">
                <div className="w-2 h-2 bg-white rounded-full"></div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <Button
            type="button"
            className="w-full h-11 font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-md mb-4"
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-11 bg-white border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-md"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  minLength={6}
                  className="h-11 pr-10 bg-white border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-md"
                />
                <button
                  type="button"
